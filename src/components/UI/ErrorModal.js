...
const ErrorModal = (props) => {
    return (
        <div>
            <div className="fixed top-0 left-0 w-full h-screen z-10 bg-[rgba(0,0,0,0.75)]"></div>
            <div className="bg-white shadow-md rounded-lg mx-auto max-w-2xl w-[90%] fixed top-[30vh] left-1/2 -translate-x-1/2 w-[80%] z-[100] overflow-hidden">
                ...
                <footer className="flex justify-end p-8">
                    <Button className="border border-[#4f005f] text-white bg-[#4f005f] py-1 px-4 hover:bg-[#741188] hover:border-[#741188]">
                        Okay
                    </Button>
                </footer>
            </div>
